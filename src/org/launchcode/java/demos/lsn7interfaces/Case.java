...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Hot Fudge", 0.20, new ArrayList<>(Arrays.asList()));
        Topping topping2 = new Topping("Almonds", 0.10, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping3 = new Topping("Peanuts", 0.10, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping4 = new Topping("Sprinkles", 0.05, new ArrayList<>(Arrays.asList("red #5", "yellow #3", "blue #6")));
